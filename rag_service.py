...
def generate_answer(question: str, contexts: list[str], sources: list[str]) -> RAQQueryResult:
...
def answer_question(question: str, top_k: int = 5) -> RAQQueryResult:
    contexts, sources = search_contexts(question, top_k)
    return generate_answer(question, contexts, sources)
